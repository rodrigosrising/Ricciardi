...
?>
<div id="payment" class="woocommerce-checkout-payment small-12 large-12 small-order-2 large-order-1 columns">
	<?php if ( WC()->cart->needs_payment() ) : ?>
		<ul class="wc_payment_methods payment_methods methods no-bullet">
			<?php
